...
// Dizzle Dynasty 2026 Rookie Rankings 6.0 (Points format from the shared Google Sheet).
// These are used only as a rookie/prospect adjustment layered onto Hashtag's overall dynasty list.
const DIZZLE_ROOKIE_DB = [
  { name: "Cameron Boozer", rookieRank: 1, tier: "1", age: 19.0 },
  { name: "AJ Dybantsa", rookieRank: 2, tier: "1.5", age: 19.4 },
  { name: "Darryn Peterson", rookieRank: 3, tier: "1.5", age: 19.5 },
  { name: "Caleb Wilson", rookieRank: 4, tier: "1.5", age: 20.0 },
  { name: "Keaton Wagler", rookieRank: 5, tier: "2", age: 19.4 },
  { name: "Darius Acuff Jr.", rookieRank: 6, tier: "2.5", age: 19.6 },
  { name: "Mikel Brown Jr.", rookieRank: 7, tier: "2.5", age: 20.3 },
  { name: "Kingston Flemings", rookieRank: 8, tier: "2.5", age: 19.4 },
  { name: "Brayden Burries", rookieRank: 9, tier: "3", age: 20.8 },
  { name: "Aday Mara", rookieRank: 10, tier: "2", age: 21.3 },
  { name: "Yaxel Lendeborg", rookieRank: 11, tier: "3", age: 23.8 },
  { name: "Ebuka Okorie", rookieRank: 12, tier: "3", age: 19.2 },
  { name: "Morez Johnson Jr.", rookieRank: 13, tier: "3", age: 20.4 },
  { name: "Hannes Steinbach", rookieRank: 14, tier: "3", age: 20.2 },
  { name: "Bennett Stirtz", rookieRank: 15, tier: "3", age: 22.8 },
  { name: "Dailyn Swain", rookieRank: 16, tier: "3", age: 21.0 },
  { name: "Cameron Carr", rookieRank: 17, tier: "4", age: 21.6 },
  { name: "LaBaron Philon", rookieRank: 18, tier: "3", age: 20.6 },
  { name: "Christian Anderson Jr.", rookieRank: 19, tier: "", age: 20.3 },
  { name: "Nate Ament", rookieRank: 20, tier: "4", age: 19.6 },
  { name: "Karim Lopez", rookieRank: 21, tier: "4", age: 19.2 },
  { name: "Tarris Reed Jr.", rookieRank: 22, tier: "4", age: 22.9 },
  { name: "Bruce Thornton", rookieRank: 23, tier: "", age: 22.8 },
  { name: "Sergio De Larrea", rookieRank: 24, tier: "4.5", age: 20.6 },
  { name: "Allen Graves", rookieRank: 25, tier: "4", age: 19.9 },
  { name: "Zuby Ejiofor", rookieRank: 26, tier: "4.5", age: 22.2 },
  { name: "Koa Peat", rookieRank: 27, tier: "4.5", age: 19.5 },
  { name: "Chris Cenac Jr.", rookieRank: 28, tier: "4", age: 19.4 },
  { name: "Jayden Quaintance", rookieRank: 29, tier: "3", age: 19.0 },
  { name: "Joshua Jefferson", rookieRank: 30, tier: "4", age: 22.6 },
  { name: "Isaiah Evans", rookieRank: 31, tier: "5", age: 20.6 },
  { name: "Meleek Thomas", rookieRank: 32, tier: "4.5", age: 19.9 },
  { name: "Richie Saunders", rookieRank: 33, tier: "6", age: 24.8 },
  { name: "Alex Karaban", rookieRank: 34, tier: "6", age: 23.7 },
  { name: "Ryan Conwell", rookieRank: 35, tier: "", age: 22.1 },
  { name: "Henri Veesaar", rookieRank: 36, tier: "4.5", age: 22.3 },
  { name: "Baba Miller", rookieRank: 37, tier: "6", age: 22.4 },
  { name: "Ja'Kobi Gillespie", rookieRank: 38, tier: "7", age: 22.3 },
  { name: "Emanuel Sharp", rookieRank: 39, tier: "6", age: 22.3 },
  { name: "Braden Smith", rookieRank: 40, tier: "5", age: 23.0 },
  { name: "Nick Martinelli", rookieRank: 41, tier: "7", age: 22.2 },
  { name: "Jaden Bradley", rookieRank: 42, tier: "7", age: 22.8 },
  { name: "Trevon Brazile", rookieRank: 43, tier: "6", age: 23.5 },
  { name: "Ugonna Onyenso", rookieRank: 44, tier: "5", age: 21.8 },
  { name: "Dillon Mitchell", rookieRank: 45, tier: "7", age: 22.8 },
  { name: "Izaiyah Nelson", rookieRank: 46, tier: "5", age: 22.8 },
  { name: "Felix Okpara", rookieRank: 47, tier: "7", age: 22.2 },
  { name: "Jack Kayil", rookieRank: 48, tier: "", age: 19.4 },
  { name: "Otega Oweh", rookieRank: 49, tier: "7", age: 23.0 },
  { name: "Tyler Bilodeau", rookieRank: 50, tier: "", age: 22.2 },
  { name: "Maliq Brown", rookieRank: 51, tier: "", age: 22.6 },
  { name: "Bryce Hopkins", rookieRank: 52, tier: "", age: 23.8 },
  { name: "Aaron Nkrumah", rookieRank: 53, tier: "", age: 24.3 },
  { name: "Tyler Nickel", rookieRank: 54, tier: "6", age: 22.8 },
  { name: "Tobi Lawal", rookieRank: 55, tier: "7", age: 23.2 },
  { name: "Lajae Jones", rookieRank: 56, tier: "", age: 22.1 },
  { name: "Quadir Copeland", rookieRank: 57, tier: "5", age: 22.8 },
  { name: "Rafael Castro", rookieRank: 58, tier: "6", age: 23.3 },
  { name: "Trey Kaufman-Renn", rookieRank: 59, tier: "", age: 23.9 },
  { name: "Jaron Pierre Jr.", rookieRank: 60, tier: "", age: 24.0 },
  { name: "Peter Suder", rookieRank: 61, tier: "7", age: 22.5 },
  { name: "Kylan Boswell", rookieRank: 62, tier: "6", age: 21.2 },
  { name: "Keyshawn Hall", rookieRank: 63, tier: "7", age: 23.2 },
  { name: "Jaylin Sellers", rookieRank: 64, tier: "", age: 23.1 },
  { name: "Nate Bittle", rookieRank: 65, tier: "6", age: 23.1 },
  { name: "Donovan Atwell", rookieRank: 66, tier: "", age: 22.9 },
  { name: "Nick Boyd", rookieRank: 67, tier: "7", age: 25.2 },
  { name: "Tre Donaldson", rookieRank: 68, tier: "7", age: 22.6 },
  { name: "Robert McCray V", rookieRank: 69, tier: "", age: 23.8 },
  { name: "Tamin Lipsey", rookieRank: 70, tier: "7", age: 23.0 },
  { name: "Malik Reneau", rookieRank: 71, tier: "", age: 23.3 },
  { name: "Duke Miles", rookieRank: 72, tier: "6", age: 24.4 },
  { name: "Lamar Wilkerson", rookieRank: 73, tier: "7", age: 24.6 },
  { name: "Kowacie Reeves", rookieRank: 74, tier: "", age: 23.4 },
  { name: "Tobe Awaka", rookieRank: 75, tier: "", age: 22.4 },
  { name: "Josh Dix", rookieRank: 76, tier: "", age: 22.0 },
  { name: "Seth Trimble", rookieRank: 77, tier: "", age: 21.9 },
  { name: "Tucker DeVries", rookieRank: 78, tier: "", age: 23.6 },
  { name: "Rienk Mast", rookieRank: 79, tier: "7", age: 25.0 },
  { name: "Ernest Udeh Jr.", rookieRank: 80, tier: "", age: 22.5 }
];
